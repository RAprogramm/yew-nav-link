...
<img src="https://raw.githubusercontent.com/RAprogramm/yew-nav-link/main/docs/assets/navlink-demo.gif" alt="Animated demo: clicking the Yew, Nav and Link tabs changes the URL path and page content while the active tab is highlighted automatically" width="740">
